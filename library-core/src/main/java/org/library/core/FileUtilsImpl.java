...
public class FileUtilsImpl implements FileUtils {
    ...
    @Override
    public LocalDateTime getFileLastModifiedDate(Path path) throws IOException {
    ...
    @Override
    public String getFileMD5Hash(Path path) throws NoSuchAlgorithmException, IOException {
     ...
     * @return
     */
    public List<Path> getFilesListEx(Path path, DirectoryStream.Filter filter) throws IOException {
     ...
     * @return
     */
    public DirectoryStream.Filter createFilter(List<String> extensions, boolean isRecursive) {
        List filterPrepared =
    ...
    private String removeTrailingPeriod(final String extension) {
        int i = 0;
